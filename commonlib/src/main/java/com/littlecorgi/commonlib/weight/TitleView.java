...
//
//         Drawable viewGroupDrawable =
//         typedArray.getDrawable(R.styleable.TitleView_titleBackground);
//         if (viewGroupDrawable == null) {
//             viewGroupDrawable =
//             ContextCompat.getDrawable(context, R.drawable.shape_gradient_title);
//         }
//         mRlViewGZroup.setBackground(viewGroupDrawable);
//
...
//             leftText = "返回";
//         }
//         final float leftTextSize =
//         typedArray.getDimension(R.styleable.TitleView_leftTextSize, 20);
