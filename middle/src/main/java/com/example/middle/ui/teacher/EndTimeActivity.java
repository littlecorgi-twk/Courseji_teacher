...
import static com.example.middle.logic.dao.SetTimeHelp.getDurationList;
import static com.example.middle.logic.dao.SetTimeHelp.getDurationMillisecondList;
import static com.example.middle.logic.dao.SetTimeHelp.getTimeDay;
import static com.example.middle.logic.dao.SetTimeHelp.getTimeHour;
...
public class EndTimeActivity extends BaseActivity {
    ...
    private void initRecyclerView() {
        ...
        adapt.setOnItemChildClickListener((adapter, view, position) -> {
            ...
            duration = getDurationMillisecondList(position);
        });
    }
    ...
    private void initWheelViewDay() {
        List<String> dayList = getTimeDay();
    ...
    private void initWheelViewHour() {
        List<String> hourList = getTimeHour();
    ...
    private void initWheelViewMinute() {
        List<String> minutesList = getTimeMinutes();
