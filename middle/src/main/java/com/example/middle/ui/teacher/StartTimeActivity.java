...
import static com.example.middle.logic.dao.SetTimeHelp.getHalfHourIndex;
import static com.example.middle.logic.dao.SetTimeHelp.getMinutesIndex;
import static com.example.middle.logic.dao.SetTimeHelp.getTimeHalfHour;
import static com.example.middle.logic.dao.SetTimeHelp.getTimeList;
import static com.example.middle.logic.dao.SetTimeHelp.getTimeMillisecondList;
import static com.example.middle.logic.dao.SetTimeHelp.getTimeMinutes;
import static com.example.middle.logic.dao.SetTimeHelp.getTimePM;
import static com.example.middle.logic.dao.SetTimeHelp.getTimePMIndex;
...
public class StartTimeActivity extends BaseActivity {
    ...
    private void intiMm() {
        minutesList = getTimeMinutes();
        mm.setAdapter(new ArrayWheelAdapter<>(minutesList));
        mm.setCurrentItem(getMinutesIndex());
        mm.setTextSize(24);
    ...
    private void initHH() {
        hourList = getTimeHalfHour();
        HH.setAdapter(new ArrayWheelAdapter<>(hourList));
        HH.setCurrentItem(getHalfHourIndex()-1);          //设置初始值
    ...
    private void initDd() {
        ...
        dd.setCurrentItem(getTimePMIndex());
        dd.setCyclic(false);
        dd.setTextSize(30);
    ...
    private void setTimeShow() {
        ...
        long startTime = getZeroMilliseconds(nowTime);          //当前时间00点的毫秒值
        try {
