...
public class middleTeacherFragment extends Fragment  {
    ...
    private void startTimeActivity() {
        StartTimeActivity.StartStartTimeActivity(getContext(), new passedDataHelp.passedStartTime() {
            @Override
    ...
    private void initEndTime() {
        TeacherEndTimeLineaLayout.setOnClickListener(v -> EndTimeActivity.StartEndTimeActivity(getContext(), (endTime1, duration) -> {
    ...
    private void response() {
        ...
        if(ISCustom) {
            ...
            map.put("EndTime", simpleDateFormat.format(SetTimeHelp.getTimeMillisecondList(Position)+ endTimeMilliseconds ) );
        }
        map.put("Lat",Lat);
        map.put("Ing",Ing);
