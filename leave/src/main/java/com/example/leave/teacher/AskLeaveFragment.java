package com.example.leave.teacher;
...
public class AskLeaveFragment extends Fragment {
    ...
    private void initDates(){
        RecyclerItem askLeave = new RecyclerItem("病假","未批准",
                "2020-12-23至2020-12-24","发烧感冒","李明");
        askLeaveLists.add(askLeave);
        RecyclerItem askLeave2 = new RecyclerItem("事假","未批准",
                "2020-12-23至2020-12-24","放假回家","张三");
    ...
    class AskLeaveAdapter extends RecyclerView.Adapter<AskLeaveAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.teacher_ask_leave_item,parent,false);
            final ViewHolder holder = new ViewHolder(view);
            holder.teacherAskLeave.setOnClickListener(new View.OnClickListener() {
                @Override
