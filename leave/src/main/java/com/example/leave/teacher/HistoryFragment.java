...
public class HistoryFragment extends Fragment {
    ...
    private void initLeaveHistory(){
        RecyclerItem history = new RecyclerItem("病假","已批准",
                "2020-12-23至2020-12-24","发烧生病","李明");
        historyList.add(history);
        RecyclerItem history2 = new RecyclerItem("事假","已批准",
    ...
    class HistoryFragmentAdapter extends RecyclerView.Adapter<HistoryFragmentAdapter.ViewHolder>{
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.teacher_history_leave_item,parent,false);
