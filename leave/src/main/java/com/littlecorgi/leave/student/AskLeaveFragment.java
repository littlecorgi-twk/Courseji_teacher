  ...
  public void onActivityCreated(@Nullable Bundle savedInstanceState) {
    ...
    radioGroupType1.setOnCheckedChangeListener(
        new RadioGroup.OnCheckedChangeListener() {
          ...
          public void onCheckedChanged(RadioGroup group, int checkedId) {
            radioButton1 =
                (RadioButton) getActivity().findViewById(radioGroupType1.getCheckedRadioButtonId());
    ...
    radioGroupType2.setOnCheckedChangeListener(
        new RadioGroup.OnCheckedChangeListener() {
          ...
          public void onCheckedChanged(RadioGroup group, int checkedId) {
            radioButton2 =
                (RadioButton) getActivity().findViewById(radioGroupType2.getCheckedRadioButtonId());
